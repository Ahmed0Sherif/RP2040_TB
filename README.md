# Intro
- This repository includes the schematics and PCB design for my first 4-layer design of an RP2040 dev. board.
- I have started this project in my college time, but finished it recently while I work as a hardware engineer.
